...
from controllers.controller import libro_bp
...
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///libreria_rol.db"
...
# Registra los blueprints de libroes y usuarios en la aplicación
